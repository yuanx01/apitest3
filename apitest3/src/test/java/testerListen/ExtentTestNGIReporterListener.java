        ...
        if (tests.size() > 0) {
            ...
            for (ITestResult result : treeSet) {
                ...
                if (result.getThrowable() != null) {
                        test.log(status, "原因：" + result.getThrowable().getMessage());
                        test.debug("请求参数为：" + testdata.get(4));
                        test.debug("执行" + testdata.get(3) + "请求" + testdata.get(2));
                } else {
